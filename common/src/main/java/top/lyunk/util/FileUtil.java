...
import top.lyunk.util.algorithmImpl.FileTypeImpl;
import top.lyunk.util.algorithmImpl.FileImpl;
...
public final class FileUtil {
    ...
    public final static void bytes2File(byte[] buf, String filePath, String fileName) {
